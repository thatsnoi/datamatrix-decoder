...
test('classic datamatrix', function () {
  ...
  expect(datamatrix.udi).toBe('03400935955838')
...
test('another classic datamatrix', function () {
  ...
  expect(datamatrix.udi).toBe('03400930145449')
...
test('Camlog datamatrix', function () {
  ...
  expect(datamatrix.udi).toBe('C201438401')
